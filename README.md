...
strict - "strict" floating-point model (implies
/fp:except)

/Qfast_transcendentals generate inline FP intrinsics even with
/fp:except
...
iso - Acquire
/release semantics not guaranteed on volatile accesses
ms - Acquire
/release semantics guaranteed on volatile accesses
...
hiddenFriend[-] enforce Standard C++ hidden friend rules (implied by
/permissive-)
externC[-] enforce Standard C++ rules for 'extern "C"' functions (implied by
/permissive-)
...
zeroSizeArrayNew[-] call member new
/delete for 0-size arrays of objects (on by default)
...
/analyze:autolog Log to \_.pftlog

/analyze:autolog:ext&lt;ext&gt; Log to \_.&lt;ext&gt;
